...
public class SQLiteProvider extends ContentProvider {
   ...
   //         db.execSQL("CREATE TABLE IF NOT EXISTS channels(_id INTEGER PRIMARY KEY, url TEXT, title TEXT, link TEXT);");
          //  db.execSQL("CREATE TABLE IF NOT EXISTS covers(_id INTEGER PRIMARY KEY, artist_id INTEGER, small TEXT, big TEXT);");
            db.execSQL("CREATE TABLE IF NOT EXISTS artists(_id INTEGER PRIMARY KEY, artist_id INTEGER, " +
                    "name TEXT, genres TEXT, tracks INTEGER, albums INTEGER, link TEXT, " +
                    "description TEXT, small TEXT, big TEXT);");
